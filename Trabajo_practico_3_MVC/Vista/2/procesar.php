<?php
    include_once "../../Control/2/validador.php";
    ...
    <!-- Abrimos sentacia else con " : " para mas adelante cerrarlo -->
        ...
        ?>
            ...
            <div class="alert alert-success p-4 m-4" role="alert">
                <h4 class="text-primary mb-3">✅ El archivo fue cargado con éxito</h4>

                <!-- Textarea -->
                <textarea class="form-control mb-3" rows="6"><?= htmlspecialchars($contenido) ?></textarea>
